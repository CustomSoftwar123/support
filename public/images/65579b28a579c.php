...
`body` tag options:
  ...
  * sidebar-mini
-->
<body class="sidebar-mini layout-fixed text-sm" onbeforeunload="ConfirmClose()" onunload="HandleOnClose()">
    ...
    <li class="nav-item {{ ( request()->is('Users/*')|| request()->is('User/*') || request()->is('User') ) ? 'menu-open' : '' }} admin">
          ...
          <!--</li>-->
            ...
            <ul class="nav nav-treeview">
              ...
              @if(auth()->user()->email!='oliver.cassidy@hse.ie')
             <li class="nav-item">
